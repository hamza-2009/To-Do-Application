  ...
  if (todoItems.length > 0) {
    todoItems.forEach((item) => {
      ...
      itemList.insertAdjacentHTML(
        "beforeend",
        `<li class="list-group-item d-flex justify-content-between align-items-center linear-gradient(120deg , #f6d365 , #fda085);">
...
document.addEventListener("DOMContentLoaded", () => {
  form.addEventListener("submit", (e) => {
    ...
    if (itemName.length === 0) {
      ...
      //  showAlert("Item has been updated.", "alert-primary");
      } else {
        // Add new Item
        const itemObj = {
          name: itemName,
